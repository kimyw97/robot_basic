...
int main(int argc, char **argv)
{
    ...
    rclcpp::Client<three_ints_interfaces::srv::ThreeInts>::SharedPtr client =
        node->create_client<three_ints_interfaces::srv::ThreeInts>("add_three_ints");

    auto request = std::make_shared<three_ints_interfaces::srv::ThreeInts::Request>();
